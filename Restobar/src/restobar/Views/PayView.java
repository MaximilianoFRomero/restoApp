...
public class PayView extends javax.swing.JFrame {
    ...
    public PayView(ControllerTable c,int idTable) {
        initComponents();
        this.cont=c;
        this.selectedTable=idTable;
        try {
            txtSubTotal.setText(cont.getTableById(selectedTable).getOrder().calculatePrice()+"");
            txtTotal.setText(cont.getTableById(selectedTable).getOrder().calculatePrice()+"");
        } catch (DAOException ex) {
            Logger.getLogger(PayView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        try {
                this.cont.endOrderByIdTable(selectedTable);
            this.dispose();
        } catch (DAOException ex) {
            Logger.getLogger(PayView.class.getName()).log(Level.SEVERE, null, ex);
        }
